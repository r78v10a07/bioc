...
${OBJECTDIR}/src/error.o: src/error.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/error.o src/error.c
...
${OBJECTDIR}/src/memory.o: src/memory.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/memory.o src/memory.c
...
${OBJECTDIR}/src/error_nomain.o: ${OBJECTDIR}/src/error.o src/error.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/error_nomain.o src/error.c;\
	else  \
...
${OBJECTDIR}/src/memory_nomain.o: ${OBJECTDIR}/src/memory.o src/memory.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/memory_nomain.o src/memory.c;\
	else  \
